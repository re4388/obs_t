...
## [索引介绍](https://javaguide.cn/database/mysql/mysql-index.html#%E7%B4%A2%E5%BC%95%E4%BB%8B%E7%BB%8D)
...
## [索引的优缺点](https://javaguide.cn/database/mysql/mysql-index.html#%E7%B4%A2%E5%BC%95%E7%9A%84%E4%BC%98%E7%BC%BA%E7%82%B9)
...
### [Hash 表](https://javaguide.cn/database/mysql/mysql-index.html#hash-%E8%A1%A8)
...
![[100_attachements/078c2ba676dba61e807b606bddb51484_MD5.png]]

但是！哈希算法有个 **Hash 冲突** 问题，也就是说多个不同的 key 最后得到的 index 相同。通常情况下，我们常用的解决办法是 **链地址法**。链地址法就是将哈希冲突数据存放在链表中。就比如 JDK1.8 之前 `HashMap` 就是通过链地址法来解决哈希冲突的。不过，JDK1.8 以后 `HashMap` 为了减少链表过长的时候搜索时间过长引入了红黑树。

![[100_attachements/ff2ab6c315073e157adb6028b0cb86b4_MD5.png]]
...
### [二叉查找树 (BST)](https://javaguide.cn/database/mysql/mysql-index.html#%E4%BA%8C%E5%8F%89%E6%9F%A5%E6%89%BE%E6%A0%91-bst)
...
![[100_attachements/af867721075b20379739b2afa594c4fb_MD5.png]]

也就是说，**二叉查找树的性能非常依赖于它的平衡程度，这就导致其不适合作为 MySQL 底层索引的数据结构。**

为了解决这个问题，并提高查询效率，人们发明了多种在二叉查找树基础上的改进型数据结构，如平衡二叉树、B-Tree、B+Tree 等。

### [AVL 树](https://javaguide.cn/database/mysql/mysql-index.html#avl-%E6%A0%91)
...
![[100_attachements/254e1491c141cb08047d6978a183cbcf_MD5.png]]
...
### [红黑树](https://javaguide.cn/database/mysql/mysql-index.html#%E7%BA%A2%E9%BB%91%E6%A0%91)
...
![[100_attachements/7dec52586146d1c6483db3256a298255_MD5.png]]
...
### [B 树 & B + 树](https://javaguide.cn/database/mysql/mysql-index.html#b-%E6%A0%91-b-%E6%A0%91)
...
![[100_attachements/1904d855c02f90e7d96597a30e83eee7_MD5.png]]

## [二级索引](https://javaguide.cn/database/mysql/mysql-index.html#%E4%BA%8C%E7%BA%A7%E7%B4%A2%E5%BC%95)
...
![[100_attachements/9534cb0aaf0917764f3aecfcc6c0257a_MD5.png]]
...
### [聚簇索引（聚集索引）](https://javaguide.cn/database/mysql/mysql-index.html#%E8%81%9A%E7%B0%87%E7%B4%A2%E5%BC%95-%E8%81%9A%E9%9B%86%E7%B4%A2%E5%BC%95)

#### [聚簇索引介绍](https://javaguide.cn/database/mysql/mysql-index.html#%E8%81%9A%E7%B0%87%E7%B4%A2%E5%BC%95%E4%BB%8B%E7%BB%8D)

聚簇索引（Clustered Index）即索引结构和数据一起存放的索引，并不是一种单独的索引类型。InnoDB 中的主键索引就属于聚簇索引。

在 MySQL 中，InnoDB 引擎的表的 `.ibd` 文件就包含了该表的索引和数据，对于 InnoDB 引擎表来说，该表的索引 (B + 树) 的每个非叶子节点存储索引，叶子节点存储索引和索引对应的数据。

#### [聚簇索引的优缺点](https://javaguide.cn/database/mysql/mysql-index.html#%E8%81%9A%E7%B0%87%E7%B4%A2%E5%BC%95%E7%9A%84%E4%BC%98%E7%BC%BA%E7%82%B9)
...
### [非聚簇索引（非聚集索引）](https://javaguide.cn/database/mysql/mysql-index.html#%E9%9D%9E%E8%81%9A%E7%B0%87%E7%B4%A2%E5%BC%95-%E9%9D%9E%E8%81%9A%E9%9B%86%E7%B4%A2%E5%BC%95)

#### [非聚簇索引介绍](https://javaguide.cn/database/mysql/mysql-index.html#%E9%9D%9E%E8%81%9A%E7%B0%87%E7%B4%A2%E5%BC%95%E4%BB%8B%E7%BB%8D)

非聚簇索引 (Non-Clustered Index) 即索引结构和数据分开存放的索引，并不是一种单独的索引类型。二级索引 (辅助索引) 就属于非聚簇索引。MySQL 的 MyISAM 引擎，不管主键还是非主键，使用的都是非聚簇索引。

非聚簇索引的叶子节点并不一定存放数据的指针，因为二级索引的叶子节点就存放的是主键，根据主键再回表查数据。

#### [非聚簇索引的优缺点](https://javaguide.cn/database/mysql/mysql-index.html#%E9%9D%9E%E8%81%9A%E7%B0%87%E7%B4%A2%E5%BC%95%E7%9A%84%E4%BC%98%E7%BC%BA%E7%82%B9)
...
![[100_attachements/86944394719fe5ad7011ee748dfd6be1_MD5.png]]

聚簇索引和非聚簇索引:

![[100_attachements/1b674479462385df450f312fcdf59d8d_MD5.png]]

#### [非聚簇索引一定回表查询吗 (覆盖索引)?](https://javaguide.cn/database/mysql/mysql-index.html#%E9%9D%9E%E8%81%9A%E7%B0%87%E7%B4%A2%E5%BC%95%E4%B8%80%E5%AE%9A%E5%9B%9E%E8%A1%A8%E6%9F%A5%E8%AF%A2%E5%90%97-%E8%A6%86%E7%9B%96%E7%B4%A2%E5%BC%95)
...
### [覆盖索引](https://javaguide.cn/database/mysql/mysql-index.html#%E8%A6%86%E7%9B%96%E7%B4%A2%E5%BC%95)
...
![[100_attachements/0d0d07f6cf5c675239f15021816c797b_MD5.png]]
...
![[100_attachements/f82531c9443a9881bc9a0c79e17c0faa_MD5.png]]
...
![[100_attachements/da8aa8d52d59f85c0769a389f04a1bf6_MD5.png]]
...
### [联合索引](https://javaguide.cn/database/mysql/mysql-index.html#%E8%81%94%E5%90%88%E7%B4%A2%E5%BC%95)
...
### [最左前缀匹配原则](https://javaguide.cn/database/mysql/mysql-index.html#%E6%9C%80%E5%B7%A6%E5%89%8D%E7%BC%80%E5%8C%B9%E9%85%8D%E5%8E%9F%E5%88%99)
...
![[100_attachements/46977307ee33157cd191bbd8d3ac92e3_MD5.png]]
...
## [索引下推](https://javaguide.cn/database/mysql/mysql-index.html#%E7%B4%A2%E5%BC%95%E4%B8%8B%E6%8E%A8)
...
![[100_attachements/e4358d575505092d147e032d009a323c_MD5.png]]

![[100_attachements/2d308755ceff18e7544df8842a6ff414_MD5.png]]

再来讲讲索引下推的具体原理，先看下面这张 MySQL 简要架构图。

![[100_attachements/6805277256528864.png]]
...
## [正确使用索引的一些建议](https://javaguide.cn/database/mysql/mysql-index.html#%E6%AD%A3%E7%A1%AE%E4%BD%BF%E7%94%A8%E7%B4%A2%E5%BC%95%E7%9A%84%E4%B8%80%E4%BA%9B%E5%BB%BA%E8%AE%AE)

### [选择合适的字段创建索引](https://javaguide.cn/database/mysql/mysql-index.html#%E9%80%89%E6%8B%A9%E5%90%88%E9%80%82%E7%9A%84%E5%AD%97%E6%AE%B5%E5%88%9B%E5%BB%BA%E7%B4%A2%E5%BC%95)
...
### [被频繁更新的字段应该慎重建立索引](https://javaguide.cn/database/mysql/mysql-index.html#%E8%A2%AB%E9%A2%91%E7%B9%81%E6%9B%B4%E6%96%B0%E7%9A%84%E5%AD%97%E6%AE%B5%E5%BA%94%E8%AF%A5%E6%85%8E%E9%87%8D%E5%BB%BA%E7%AB%8B%E7%B4%A2%E5%BC%95)

虽然索引能带来查询上的效率，但是维护索引的成本也是不小的。 如果一个字段不被经常查询，反而被经常修改，那么就更不应该在这种字段上建立索引了。

### [限制每张表上的索引数量](https://javaguide.cn/database/mysql/mysql-index.html#%E9%99%90%E5%88%B6%E6%AF%8F%E5%BC%A0%E8%A1%A8%E4%B8%8A%E7%9A%84%E7%B4%A2%E5%BC%95%E6%95%B0%E9%87%8F)
...
### [尽可能的考虑建立联合索引而不是单列索引](https://javaguide.cn/database/mysql/mysql-index.html#%E5%B0%BD%E5%8F%AF%E8%83%BD%E7%9A%84%E8%80%83%E8%99%91%E5%BB%BA%E7%AB%8B%E8%81%94%E5%90%88%E7%B4%A2%E5%BC%95%E8%80%8C%E4%B8%8D%E6%98%AF%E5%8D%95%E5%88%97%E7%B4%A2%E5%BC%95)

因为索引是需要占用磁盘空间的，可以简单理解为每个索引都对应着一颗 B + 树。如果一个表的字段过多，索引过多，那么当这个表的数据达到一个体量后，索引占用的空间也是很多的，且修改索引时，耗费的时间也是较多的。如果是联合索引，多个字段在一个索引上，那么将会节约很大磁盘空间，且修改数据的操作效率也会提升。

### [注意避免冗余索引](https://javaguide.cn/database/mysql/mysql-index.html#%E6%B3%A8%E6%84%8F%E9%81%BF%E5%85%8D%E5%86%97%E4%BD%99%E7%B4%A2%E5%BC%95)

冗余索引指的是索引的功能相同，能够命中索引 (a, b) 就肯定能命中索引 (a) ，那么索引 (a) 就是冗余索引。如（name,city ）和（name ）这两个索引就是冗余索引，能够命中前者的查询肯定是能够命中后者的 在大多数情况下，都应该尽量扩展已有的索引而不是创建新索引。

### [字符串类型的字段使用前缀索引代替普通索引](https://javaguide.cn/database/mysql/mysql-index.html#%E5%AD%97%E7%AC%A6%E4%B8%B2%E7%B1%BB%E5%9E%8B%E7%9A%84%E5%AD%97%E6%AE%B5%E4%BD%BF%E7%94%A8%E5%89%8D%E7%BC%80%E7%B4%A2%E5%BC%95%E4%BB%A3%E6%9B%BF%E6%99%AE%E9%80%9A%E7%B4%A2%E5%BC%95)
...
### [删除长期未使用的索引](https://javaguide.cn/database/mysql/mysql-index.html#%E5%88%A0%E9%99%A4%E9%95%BF%E6%9C%9F%E6%9C%AA%E4%BD%BF%E7%94%A8%E7%9A%84%E7%B4%A2%E5%BC%95)

删除长期未使用的索引，不用的索引的存在会造成不必要的性能损耗。

MySQL 5.7 可以通过查询 `sys` 库的 `schema_unused_indexes` 视图来查询哪些索引从未被使用。

### [知道如何分析 SQL 语句是否走索引查询](https://javaguide.cn/database/mysql/mysql-index.html#%E7%9F%A5%E9%81%93%E5%A6%82%E4%BD%95%E5%88%86%E6%9E%90-sql-%E8%AF%AD%E5%8F%A5%E6%98%AF%E5%90%A6%E8%B5%B0%E7%B4%A2%E5%BC%95%E6%9F%A5%E8%AF%A2)
